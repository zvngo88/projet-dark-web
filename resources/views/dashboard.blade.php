...
<body class="bg-gray-100">
    ...
    <div class="py-12 bg-gradient-to-b from-blue-500 to-blue-300">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="text-center">
                ...
                <form method="GET" action="{{ route('search') }}" class="flex justify-center items-center bg-white rounded-full shadow-lg">
                    <input type="text" id="queryInput" name="query" placeholder="Rechercher une fuite" 
                        ...
                        pattern="[a-zA-Z0-9\s]+" title="Seuls les lettres, chiffres et espaces sont autorisés." required>
                ...
                <script>
                    document.getElementById('queryInput').addEventListener('input', function (event) {
                        ...
                        if (!regex.test(event.target.value)) {
                            ...
                            alert("Seuls les lettres, chiffres et espaces sont autorisés dans la recherche.");
                        }
                    });
                </script>
    ...
    <!-- Section sponsor (similaire à HIBP avec 1Password) -->
   <!-- <div class="py-6 bg-gradient-to-b from-blue-400 to-blue-200 text-center">
        <div class="container mx-auto">
            <img src="https://1password.com/images/logo.svg" alt="1Password Logo" class="inline-block h-12">
            <p class="text-lg text-gray-800 mt-4">Générez des mots de passe uniques et sécurisés pour chaque compte</p>
            <a href="https://1password.com" class="text-blue-500 underline">En savoir plus sur 1Password.com</a>
        </div>
    </div>-->
    ...
    <!-- Script pour activer/désactiver le bouton de recherche -->
    <script>
